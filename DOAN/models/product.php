...
class Product{
    ...
    public function getproduct_description(){return $this->product_description; }
    ...
    $product_thumbnail,$product_producer,$product_origin,$product_description,$product_preview){
