...
?>
            ...
            <main class="content dynamic-container">
                <h3 style="width: fit-content; margin: 0 auto 1rem auto;">MAKE-UP</h3>
...
<?php
                if(isset($_GET['submit'])){
                    require_once($_SERVER['DOCUMENT_ROOT']."/CONCASAU/DOAN/controllers/filter_controller.php");
                    $controller = new FilterController();
                    $controller->women_fg_category_invoke("filter");
                }
                else{
                    require_once($_SERVER['DOCUMENT_ROOT']."/CONCASAU/DOAN/controllers/filter_controller.php");
                    $controller = new FilterController();
                    $controller->women_fg_category_invoke("all");
                }
