            ...
            <main class="content dynamic-container">
                ...
                <div id="slides" class="carousel slide carousel-light carousel-fade" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="/CONCASAU/DOAN/images/index-top-img-1.jpg" />
                            </div>
                            <div class="carousel-item">
                                <img src="/CONCASAU/DOAN/images/index-top-img-2.jpg" height="800"/>
                            </div>
                            <div class="carousel-item">
                                <img src="/CONCASAU/DOAN/images/index-top-img-3.jpg" height="800"/>
                            </div>
                ...
                <div class="image-container">
                    ...
                    <div class="embed-responsive embed-responsive-16by9 text-center">
                        ...
                        <source
                            src="/CONCASAU/DOAN/video/index-video-1.mp4"
                            type="video/mp4">
                        </video>
                    </div>
                    </div>
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="row">
                        <?php
                            require_once($_SERVER['DOCUMENT_ROOT']."/CONCASAU/DOAN/controllers/index_controller.php");
                ...
                <div class="image-container">
                    ...
                    <video class="videoDiv video-mp4" width="100%" autoplay muted loop>
                        <source
                        src="/CONCASAU/DOAN/video/index-video-2.mp4"
                        type="video/mp4">
                    </video>
                    </div>
                </div>
                ...
                <div class="image-container">
                    ...
                    <video class="videoDiv video-mp4" width="100%" autoplay muted loop>
                        <source
                        src="/CONCASAU/DOAN/video/index-video-3.mp4"
                        type="video/mp4">
                    </video>
                    </div>
                </div>
